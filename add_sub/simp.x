...
/* If I want to put something explicitly in the .h file produced 
   by rpcgen I can start it with %:
*/
...
/* This defines the RPC program number as 555555555, although 
   within the client and server code I can just refer to it as 
   SIMP_PROG. In other words, rpcgen will put this line in 
   the .h file:
...
of the remote procedures. The stub prototype for the add procedure 
looks like this:
